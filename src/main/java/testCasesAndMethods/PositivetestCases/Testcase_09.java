...
public class Testcase_09 extends student_repo
{
	@Test
	public static void testcase_09() throws Exception
	{
		...
		Thread.sleep(3000);
		Assert.assertEquals(true, student_repo.discussionAsk().isDisplayed()); 
